...
$THEME->layouts = array(
    ...
    'frontpage' => array(
        'file' => 'frontpage.php',
        'regions' => array('side-post','slideshow','products-left','products-middle','products-right','clients','footer-left','footer-middle','footer-right'),
        'defaultregion' => 'side-post',
    ),
    'admin' => array(
        'file' => 'general.php',
...
$THEME->csspostprocess = 'pukunui_process_css';
